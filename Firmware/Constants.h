...
static const uint8_t defaultSettings[][4] PROGMEM = {
  ...
  {  50, 235,  40,    DYNAMIC}, // Сканер             |  {"n":"Сканер","v":[1,255,1,100,1]}, Scanner
  ...
  {  75, 200,  25, SOFT_DELAY}, // Старий маяк        |  {"n":"Старий маяк","v":[100,255,1,100,0]}, Lighthouse
  // {  10, 255,  30, SOFT_DELAY}, // Полтавські Маки    |  {"n":"Полтавські Маки","v":[128,128,1,100,1]}, Poltava Poppies
  ...
  {  10, 207,  60, HIGH_DELAY}, // Бeлый cвeт
