...
uint8_t alarm_volume = 4U;                // Громкость будильника
...
uint8_t mp3_delay = 500;                 // Затрімка між командами плеєру
...
uint8_t sound_timeout = 0;
uint8_t action_timeout = 0;
int currentNote;
int notes;
...
void setup() {
  ...
  FastLED.addLeds<WS2812B, LED_PIN, COLOR_ORDER>(leds, NUM_LEDS + 2);
#else
